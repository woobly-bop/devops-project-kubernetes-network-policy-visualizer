...
- Extract pod communication rules
- Generate a visual graph of allowed and denied connections
- Containerize the application using Docker
- Deploy the tool on Kubernetes

### Key Features
- YAML parser for NetworkPolicy files
- Graph-based visualization of pod communication
